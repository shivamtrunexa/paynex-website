...
const Philosophy = () => {
    ...
    return (
        <section ref={sectionRef} className="w-full h-full bg-white overflow-hidden">
            ...
            <div className="xl:hidden w-full px-8 py-20 flex flex-col justify-center items-center gap-[50px]">
                ...
                <div className="w-full flex flex-col justify-center items-start gap-6">
                    <div className="w-full flex flex-col justify-start items-start gap-3">
                        ...
                        {/* Subtitle */}
                        <div className="w-full text-[#45556C] text-base leading-6 font-normal">
                ...
                <div className="w-full bg-white flex flex-col justify-start items-start gap-10">
                    ...
                    >
                        <Workflow className="w-6 h-6 text-[#1876F4] stroke-2" />

                        <div className="w-full flex justify-start items-center gap-2.5">
                            <h3 className="flex justify-center flex-col text-[#1876F4] text-2xl font-medium leading-[30px]">
                                Seamless Integration
                            </h3>
                        </div>

                        <p className="w-full text-[#45556C] text-base font-normal leading-6">
                    ...
                    >
                        <Layers2 className="w-6 h-6 text-[#1876F4] stroke-2" />
                        <div className="w-full flex justify-start items-center gap-2.5">
                            <h3 className="flex justify-center flex-col text-[#1876F4] text-2xl font-medium leading-[30px]">
                                Scalable Architecture
                            </h3>
                    ...
                    >
                        <DraftingCompass className="w-6 h-6 text-[#1876F4] stroke-2" />
                    ...
                    >
                        <UsersRound className="w-6 h-6 text-[#1876F4] stroke-2" />
                        <div className="w-full flex justify-start items-center gap-2.5">
                            <h3 className="flex justify-center flex-col text-[#1876F4] text-2xl font-medium leading-[30px]">
                                User-Centric Experience
                            </h3>
            ...
            {/* Desktop Layout */}
            <div className="hidden xl:flex max-w-[1920px] mx-auto justify-start items-center">
